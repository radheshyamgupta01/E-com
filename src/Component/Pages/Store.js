      ...
      <div className="container mx-auto">
        <div className="flex flex-wrap">
          {products.map((item, index) => (
            <div
              key={index}
              className="sm:w-1/2 md:w-1/3 lg:w-1/4 xl:w-1/6 p-4 m-4 ml-5 border w-full overflow-hidden transition-transform transform duration-300 ease-in-out hover:scale-110"
            >
